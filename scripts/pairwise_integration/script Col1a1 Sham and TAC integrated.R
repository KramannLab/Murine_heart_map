#script for analysis of Col1a1 Sham and TAC integrated
library(Seurat)
library(cowplot)
library(ggplot2)
library(clustree)
...
Samples.combined = readRDS(file = "~/Documents/FP_scRNA/R stuff/analysis PVM_v8/RDS_basic_filtering_Sham&TAC_integrated/Col1a1_Sham&TAC_integrated_seurat_object_after_bacis_filters.rds")
...
Samples.combined=subset(Samples.combined,idents = c("8"),invert=T)
...
Sham = subset(Samples.combined,idents = "FP19_Col1a1_Sham")
saveRDS(Sham,file = paste0(sample,"pairwise/",sample,"_Sham_indiv_after_pairwise_integration.rds"))
TAC = subset(Samples.combined,idents = "FP18_Col1a1_TAC")
